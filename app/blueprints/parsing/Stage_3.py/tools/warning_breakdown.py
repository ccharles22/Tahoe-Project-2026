...
Run with: PYTHONPATH=. py -3 tools/warning_breakdown.py data/DE_BSU_Pol_Batch_1.tsv
"""
import sys
import collections
import re
...
def main():
    if len(sys.argv) < 2:
        print('Usage: tools/warning_breakdown.py <tsv-file> [percentile_low percentile_high dna_floor protein_floor]')
        return
