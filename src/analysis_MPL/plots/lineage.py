...
def _node_label(row: pd.Series, *, generation_col: str, node_id_col: str) -> str: #build label for a node based on generation and ID (with some heuristics for compactness)
